...
export default function Pattern_white({ ...props }: Props) {
  ...
  return (
    <div {...props}>
      <motion.svg
        ...
        className={`max-w-full fill-peacoat-50 stroke-peacoat-200`}
        strokeDasharray={"100%"}
      ...
      >
        <defs>
          ...
          >
            ...
            <stop offset=".12" stopColor="#fff" stopOpacity=".94" />
            <stop offset=".32" stopColor="#fff" stopOpacity=".79" />
            <stop offset=".57" stopColor="#fff" stopOpacity=".53" />
            <stop offset=".86" stopColor="#fff" stopOpacity=".19" />
        ...
        <rect className="cls-16" width="2000" stroke="0px" height="2000" />
        <motion.g transition={{ delayChildren: 5 }}>
          <motion.path
