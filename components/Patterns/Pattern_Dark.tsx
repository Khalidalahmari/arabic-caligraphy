  ...
  return (
    <div {...props}>
      <motion.svg
        ...
        animate="show"
        stroke={"2px"}
        className={`h-full w-full max-w-full stroke-peacoat-800`}
        strokeDasharray={"100%"}
      ...
      >
        <defs>
          ...
          >
            ...
            <stop offset=".12" stopColor="#3b3b46" stopOpacity="1" />
            <stop offset=".32" stopColor="#3b3b46" stopOpacity=".94" />
            <stop offset=".57" stopColor="#3b3b46" stopOpacity=".53" />
            <stop offset=".86" stopColor="#3b3b46" stopOpacity=".19" />
            <stop offset="1" stopColor="#3b3b46" stopOpacity="0" />
          </linearGradient>
          <linearGradient
