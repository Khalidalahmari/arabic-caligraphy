...
export default function Pattern_Dark({ ...props }: Props) {
  ...
  return (
    <div {...props}>
      <motion.svg
        ...
        animate="show"
        stroke={"2px"}
        className={`stroke-peacoat-6s00 h-full w-full max-w-full`}
        strokeDasharray={"100%"}
      ...
      >
        <defs>
          ...
          >
            <stop offset="0" stopColor="#3f3b46" />
            <stop offset=".12" stopColor="#3f3b46" stopOpacity="1" />
            <stop offset=".32" stopColor="#3f3b46" stopOpacity=".94" />
            <stop offset=".57" stopColor="#3f3b46" stopOpacity=".53" />
            <stop offset=".86" stopColor="#3f3b46" stopOpacity=".19" />
            <stop offset="1" stopColor="#3f3b46" stopOpacity="0" />
          </linearGradient>
          <linearGradient
            id="linear-gradient-dark-2"
            x1="1666.99"
            y1="1655.49"
            x2="1705.07"
            y2="1655.49"
            xlinkHref="#linear-gradient-Dark"
          />
          <linearGradient
            id="linear-gradient-dark-3"
            x1="1365.29"
            y1="1431.97"
            x2="1403.37"
            y2="1431.97"
        ...
        <rect className="cls-dark-16" width="2000" height="2000" />
        ...
        <g>
          ...
          <g>
            ...
            <motion.path
              ...
              className="cls-dark-32"
              d="m1017.24,522.35c-5.11.48-10.27.52-15.46.15,5.19.25,10.36.19,15.46-.15Z"
            />
            <rect
              className="cls-dark-66"
              x="1084.7"
              y="464.5"
              width="0"
              height="0"
